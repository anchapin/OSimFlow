    ...
    def _build_task_payload(
        *,
        ...
        payload = {
            ...
            "name": name,
            "step": step_name,
            "args": [GoogleBatchExecutor._encode_payload_value(a) for a in args],
            "kwargs": {k: GoogleBatchExecutor._encode_payload_value(v) for k, v in kwargs.items()},
            "result_hint": GoogleBatchExecutor._encode_payload_value(result_hint),
        }
