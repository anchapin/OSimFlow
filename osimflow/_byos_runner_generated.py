...
_BYOS_CONTRACT_SNAPSHOT: dict[str, dict[str, object]] = {'aggregate_results': {'accepts_kwargs': True,
                       'param_names': ('kpi_files', 'sim_dirs', 'out'),
                       'required_positional': 3},
 'apply': {'accepts_kwargs': False,
 ...
 'extract_kpis': {'accepts_kwargs': True,
                  ...
                  'required_positional': 3},
 'generate_plots': {'accepts_kwargs': True,
...
_INLINE_BYOS_CONTRACT = {'aggregate_results': {'accepts_kwargs': True,
                       'param_names': ('kpi_files', 'sim_dirs', 'out'),
                       'required_positional': 3},
 'apply': {'accepts_kwargs': False,
           'param_names': ('template', 'parameters', 'sample_id', 'out'),
