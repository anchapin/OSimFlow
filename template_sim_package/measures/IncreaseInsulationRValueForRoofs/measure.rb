...
class IncreaseInsulationRValueForRoofs < OpenStudio::Measure::ModelMeasure
  ...
  def self._original_source
    return 'https://github.com/NREL/openstudio-ee-gem/tree/66988daabc419d8eb682177cfc7314071ac7b40c/lib/measures/IncreaseInsulationRValueForRoofs'
  end
  ...
  def run(model, runner, user_arguments)
    ...
    if !ENV['SAVE_INTERMEDIATE'].nil?
      model.save('5.1.before_IncreaseInsulationRValueForRoofs.osm')
    end
    ...
    if (r_value < 0) || (r_value > 500)
      ...
      return false
    elsif r_value > 80 # Changed from original source
    ...
    if !ENV['SAVE_INTERMEDIATE'].nil?
      model.save('5.2.after_IncreaseInsulationRValueForRoofs.osm')
    end
