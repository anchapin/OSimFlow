...
# rubocop:disable Metrics/ParameterLists, Performance/CollectionLiteralInLoop
...
class AddHeatPumpRtu < OpenStudio::Measure::ModelMeasure
  ...
  def run(model, runner, user_arguments)
    ...
    if !ENV['SAVE_INTERMEDIATE'].nil?
      model.save('15.1.before_upgrade_hvac_add_heat_pump_rtu.osm')
    end
    ...
    runner.registerValue('system_type_hvac_upgrade', 'HP RTU')
...
# rubocop:enable Metrics/ParameterLists, Performance/CollectionLiteralInLoop
