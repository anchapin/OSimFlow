...
# replace_baseline_windows_r_values

## Description
Replaces the windows in the baseline based on corresponding U-value, SHGC, and VLT.
...
Identify window framing type to be applied to entire building for usage with Openstudio Standards
**Name:** fenestration_frame_type,
**Type:** Choice,
**Units:** ,
**Required:** true,
**Model Dependent:** false
